...
-- CreateEnum
CREATE TYPE "NotifyStatus" AS ENUM ('queued', 'sending', 'sent', 'failed');
...
CREATE TABLE "houses" (
    ...
    "waiting_on_eta" DATE,
    "next_week" TEXT,
    "next_week_set_at" TIMESTAMPTZ(3),
    "handover_from" DATE,
    "handover_to" DATE,
    "handed_over_at" DATE,
...
-- CreateIndex
CREATE INDEX "notification_logs_status_next_attempt_at_idx" ON "notification_logs"("status", "next_attempt_at");
